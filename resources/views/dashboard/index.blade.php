        ...
        <div class="dash-hero">
            <div class="dash-hero-inner">
                <div class="hero-left">
                    ...
                    <p>Sistema de Gestion de Informacion Estudiantil y Admisiones — CUP</p>
                </div>
        ...
        <div class="info-card">
            <div class="info-card-header">
                ...
                <div>
                    ...
                    <div class="info-card-sub">CUP</div>
                </div>
            </div>
            <div class="gold-rule"></div>
            <p>Este es el panel principal del sistema CUP.</p>
